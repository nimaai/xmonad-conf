...
myNormalBorderColor  = "#2E83F2"      -- color of inactive border
...
gsconfig = defaultGSConfig { gs_font = "xft:Inconsolata:size=14", gs_navigate = navNSearch }
...
myKeys = myKeyBindings ++
  ...
  [
    ((m .|. myModMask, key), screenWorkspace sc
      ...
      | (key, sc) <- zip [xK_bracketleft, xK_bracketright] [1,0]
